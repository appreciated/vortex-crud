...
VALUES
    ...
    ('User Authentication', 'Implement the user authentication module', 4, 'In Progress', '2023-11-20', NOW(), NOW()),
    ('Frontend Integration', 'Integrate the frontend with the backend API', 5, 'Pending Review', '2023-12-10', NOW(), NOW()),
    ('Bug Fixes', 'Fix critical bugs reported by the QA team', 6, 'In Progress', '2023-10-15', NOW(), NOW()),
    ('API Documentation', 'Write documentation for the REST API endpoints', 7, 'Not Started', '2023-11-05', NOW(), NOW()),
    ('Performance Optimization', 'Optimize the database queries for faster performance', 2, 'In Progress', '2023-12-01', NOW(), NOW()),
    ('Code Review', 'Review the codebase for Project Alpha', 4, 'Completed', '2023-09-25', NOW(), NOW()),
    ('UI Testing', 'Perform user interface testing for the mobile app', 5, 'Pending Review', '2023-11-30', NOW(), NOW()),
    ('Security Audit', 'Conduct a security audit for Project Delta', 3, 'In Progress', '2024-01-15', NOW(), NOW()),
    ('Marketing Campaign', 'Plan the marketing campaign for product launch', 8, 'Not Started', '2024-02-01', NOW(), NOW()),
    ('Data Migration', 'Migrate old data to the new database schema', 2, 'Completed', '2023-10-05', NOW(), NOW()),
    ('Client Meeting', 'Schedule a meeting with the client to discuss requirements', 1, 'Scheduled', '2023-10-18', NOW(), NOW()),
    ('Testing Framework Setup', 'Set up a testing framework for the new microservices', 6, 'Not Started', '2023-12-15', NOW(), NOW()),
    ('Content Update', 'Update the content on the landing page', 7, 'Completed', '2023-09-28', NOW(), NOW()),
    ('Payment Gateway Integration', 'Integrate the payment gateway for online transactions', 4, 'In Progress', '2023-11-25', NOW(), NOW()),
    ('Server Maintenance', 'Perform maintenance on the main server', 5, 'Scheduled', '2023-10-22', NOW(), NOW()),
    ('UI Enhancements', 'Implement new UI enhancements based on user feedback', 3, 'In Progress', '2024-01-05', NOW(), NOW()),
    ('SEO Optimization', 'Optimize the website for better search engine rankings', 8, 'Not Started', '2024-03-01', NOW(), NOW()),
    ('Mobile App Deployment', 'Deploy the mobile app to the App Store and Play Store', 7, 'Completed', '2023-10-10', NOW(), NOW()),
    ('Email Notifications', 'Set up automated email notifications for user actions', 2, 'In Progress', '2023-12-20', NOW(), NOW()),
    ('Accessibility Review', 'Review the app for accessibility compliance', 4, 'Pending Review', '2023-11-17', NOW(), NOW()),
    ('Cloud Migration', 'Migrate services to the new cloud provider', 6, 'In Progress', '2024-02-10', NOW(), NOW());
