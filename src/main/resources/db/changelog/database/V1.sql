...
VALUES ('Project Alpha', 'A high-priority project aimed at improving the internal system', '2023-01-01', '2023-12-31',
       ...
       ('Project Delta', 'Upgrade of legacy systems to modern infrastructure', '2023-02-01', '2023-10-31', NOW(),
        NOW()),
       ('Project Epsilon', 'Migration of data from old to new database systems', '2023-03-01', '2023-09-30', NOW(),
        NOW()),
       ...
       ('Project Eta', 'Development of a machine learning model for predictive analytics', '2023-06-01', '2024-05-01',
        NOW(), NOW()),
       ('Project Theta', 'Rebranding and marketing strategy for new products', '2023-07-01', '2024-02-28', NOW(),
        NOW()),
       ...
       ('Project Lambda', 'Integration of new API systems for external partners', '2023-10-01', '2024-05-31', NOW(),
        NOW()),
       ('Project Mu', 'Development of an AI-powered recommendation engine', '2023-11-01', '2024-06-01', NOW(), NOW()),
       ('Project Nu', 'Implementation of cybersecurity protocols across all systems', '2023-12-01', '2024-07-01', NOW(),
        NOW()),
       ('Project Xi', 'Redesign of the company website for better user experience', '2024-01-01', '2024-08-01', NOW(),
        NOW()),
       ('Project Omicron', 'Developing a blockchain-based data storage solution', '2024-02-01', '2024-09-01', NOW(),
        NOW()),
       ('Project Pi', 'Optimization of the supply chain management system', '2024-03-01', '2024-10-01', NOW(), NOW()),
       ('Project Rho', 'Building an analytics dashboard for executive reporting', '2024-04-01', '2024-11-01', NOW(),
        NOW()),
       ('Project Sigma', 'Development of a social media monitoring tool', '2024-05-01', '2024-12-01', NOW(), NOW()),
       ('Project Tau', 'Research and development of a voice recognition system', '2024-06-01', '2025-01-01', NOW(),
        NOW()),
       ('Project Upsilon', 'Creation of a new HR management system', '2024-07-01', '2025-02-01', NOW(), NOW()),
       ('Project Phi', 'Implementation of a new financial management platform', '2024-08-01', '2025-03-01', NOW(),
        NOW()),
       ('Project Chi', 'Development of a video conferencing platform for remote teams', '2024-09-01', '2025-04-01',
        NOW(), NOW()),
       ('Project Psi', 'Building a customer loyalty program based on AI insights', '2024-10-01', '2025-05-01', NOW(),
        NOW()),
       ('Project Omega', 'Research into the development of a quantum computing algorithm', '2024-11-01', '2025-06-01',
        NOW(), NOW()),
       ('Project Alpha 2.0', 'Next phase of the internal system improvement project', '2024-12-01', '2025-07-01', NOW(),
        NOW()),
       ('Project Beta 2.0', 'Expansion of the customer-facing web application for global markets', '2025-01-01',
        '2025-08-01', NOW(), NOW()),
       ('Project Gamma 2.0', 'Enhancements to the AI model with additional features', '2025-02-01', '2025-09-01', NOW(),
        NOW()),
...
VALUES ('Design Homepage', 'Create the design for the homepage of the web app', 1, 'work-in-progress', '2023-12-01',
       ...
       ('User Authentication', 'Implement the user authentication module', 4, 'work-in-progress', '2023-11-20', NOW(),
        NOW()),
       ...
       ('UI Testing', 'Perform user interface testing for the mobile app', 5, 'work-in-progress', '2023-11-30', NOW(),
        NOW()),
       ('Security Audit', 'Conduct a security audit for Project Delta', 3, 'work-in-progress', '2024-01-15', NOW(),
        NOW()),
       ...
       ('Client Meeting', 'Schedule a meeting with the client to discuss requirements', 1, 'open', '2023-10-18', NOW(),
        NOW()),
       ...
       ('UI Enhancements', 'Implement new UI enhancements based on user feedback', 3, 'work-in-progress', '2024-01-05',
        NOW(), NOW()),
       ('SEO Optimization', 'Optimize the website for better search engine rankings', 8, 'open', '2024-03-01', NOW(),
        NOW()),
       ...
       ('Accessibility Review', 'Review the app for accessibility compliance', 4, 'work-in-progress', '2023-11-17',
        NOW(), NOW()),
       ('Cloud Migration', 'Migrate services to the new cloud provider', 6, 'work-in-progress', '2024-02-10', NOW(),
        NOW());
