...
public class DefaultGridRouteImpl extends VerticalLayout {
    public DefaultGridRouteImpl(int i, RouteConfig config, DynamicEntityManagerService entityManagerService, FlowCmsItemRendererFactory entityCardRendererFactory) {
