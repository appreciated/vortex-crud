...
public class DefaultRouteFactoryImpl implements FlowCmsRouteFactory {
    ...
    public DefaultRouteFactoryImpl(DynamicEntityManagerService dynamicEntityManager, FlowCmsItemRendererFactory entityCardRendererFactory, FlowCmsEntityDetailFactory detailRendererFactory, FlowCmsConfigService flowCmsConfigService, FlowCmsListColumnFactory flowCmsListColumnFactory) {
        ...
        rendererHashMap.put("list", (i, config, entityManagerService) -> new DefaultListRouteImpl(i, config, dynamicEntityManager, flowCmsConfigService, flowCmsListColumnFactory));
