...
public class DefaultListRouteFactoryImpl extends VerticalLayout {
    public DefaultListRouteFactoryImpl(int i, RouteConfig config, FlowCmsEntityManagerService entityManagerService, FlowCmsConfigService cmsConfigService, FlowCmsListColumnCallbackRegistry listColumnFactory, FlowCmsIcon flowCmsIcon) {
