...
public class TCListRouteFactory implements TurboCrudRouteFactory {
    ...
    public TCListRouteFactory(TurboCrudEntityManagerFactoryRegistry entityManagerFactoryRegistry,
