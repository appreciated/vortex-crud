...
/**
 * Base test for PDF field functionality.
 */
public abstract class AbstractPdfTest extends BaseUITest {

    protected String getPath() {
        return "pdf-documents-grid";
    }
    ...
    void testCreateEntry() {
        ...
        WebElement field = waitForElement(By.xpath("//vaadin-dialog//vaadin-text-field"))
                .findElement(By.tagName("input"));
        field.sendKeys("Created PDF Entry");
        waitForAnyElementContainingText("Save").click();
        waitForUrlToBe(getPath());
        waitForAnyElementContainingText("Created PDF Entry");
    }
    ...
    void testUpdateEntry() {
        ...
        WebElement field = waitForElement(By.tagName("vaadin-text-field"))
                .findElement(By.tagName("input"));
        field.clear();
        field.sendKeys("Updated PDF Entry");
        waitForAnyElementContainingText("Save").click();
        waitForUrlToBe(getPath());
        waitForAnyElementContainingText("Updated PDF Entry");
    }
    ...
    @Test
    void testPdfEmbedDisplayed() {
        navigateTo(getPath());
        waitForAnyElementContainingText(getExpectedVisibleValue());
        WebElement embed = waitForElement(By.tagName("embed"));
        assertTrue(embed.isDisplayed());
    }
}
