...
public class JooqOneToMany implements OneToMany<TableRecord<?>, TableField<?, ?>, TableImpl<?>> {
    ...
    @Override
    public List<TableRecord<?>> getData(Object foreignKeyValue, VortexCrudQueryDataStore<TableField<?, ?>, ?> dataStore, CollectionConfiguration<TableRecord<?>, TableField<?, ?>, TableImpl<?>> collectionConfiguration) {
