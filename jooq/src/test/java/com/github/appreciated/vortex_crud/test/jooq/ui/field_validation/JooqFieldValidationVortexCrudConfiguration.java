        ...
        Map<TableImpl<?>, DataStoreConfig<TableRecord<?>, TableField<?, ?>, TableImpl<?>>> dataStores = Map.of(
                VALIDATION_TEST, JooqDataStoreConfig.of(VALIDATION_TEST)
                        .fields(Map.of(
                                ...
                                VALIDATION_TEST.REQUIRED_FIELD, JooqTextField.builder().required(true).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
                                VALIDATION_TEST.EMAIL_FIELD, JooqEmailField.builder().validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(500))).build(),
                                VALIDATION_TEST.NUMERIC_FIELD, JooqDoubleField.builder().validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.doubleMin(1.0))).build(),
