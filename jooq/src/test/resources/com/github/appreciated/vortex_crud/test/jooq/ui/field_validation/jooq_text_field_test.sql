...
DROP TABLE IF EXISTS validation_test_text;

CREATE TABLE validation_test_text
(
...
INSERT INTO validation_test_text (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
