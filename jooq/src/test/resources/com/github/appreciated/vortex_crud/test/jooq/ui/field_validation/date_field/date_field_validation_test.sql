DROP TABLE IF EXISTS date_field_validation_test;
...
INSERT INTO date_field_validation_test (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
