DELETE
FROM validation_lifecycle_test;

-- Seed data for jOOQ field validation tests
INSERT INTO validation_lifecycle_test (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
