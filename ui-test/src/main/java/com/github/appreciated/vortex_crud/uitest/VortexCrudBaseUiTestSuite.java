...
import com.github.appreciated.vortex_crud.uitest.pages.TasksMasterDetailTest;
...
@Suite
@Profile("ui-tests")
@SelectClasses({TasksMasterDetailTest.class, ProjectCardsTest.class, ProjectGridTest.class})
