...
DROP TABLE IF EXISTS validation_test_select;

CREATE TABLE validation_test_select
(
...
INSERT INTO validation_test_select (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
