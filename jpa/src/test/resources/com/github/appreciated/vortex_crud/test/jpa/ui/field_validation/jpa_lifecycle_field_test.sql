...
DROP TABLE IF EXISTS validation_test_lifecycle;

CREATE TABLE validation_test_lifecycle
(
...
INSERT INTO validation_test_lifecycle (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
