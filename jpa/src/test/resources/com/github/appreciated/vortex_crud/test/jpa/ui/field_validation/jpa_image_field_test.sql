...
DROP TABLE IF EXISTS validation_test_image;

CREATE TABLE validation_test_image
(
...
INSERT INTO validation_test_image (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
