-- Seed data for JPA number field tests
INSERT INTO number_field_test (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
