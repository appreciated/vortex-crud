...
DROP TABLE IF EXISTS validation_test_email;

CREATE TABLE validation_test_email
(
...
INSERT INTO validation_test_email (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
