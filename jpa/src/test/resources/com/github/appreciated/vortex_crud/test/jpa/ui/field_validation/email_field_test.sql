-- Seed data for JPA email field tests
INSERT INTO email_field_test (id, required_field, email_field, numeric_field, date_field, datetime_field, enum_field, checkbox_field, image_field)
