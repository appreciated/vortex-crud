...
@Service
public class ManyToManyVortexCrudConfiguration implements VortexCrudConfigurationProvider<JpaRepository<?, ?>, String, JpaRepository<?, ?>> {

    private final ManyToManyEntityRepository itemRepository;

    public ManyToManyVortexCrudConfiguration(ManyToManyEntityRepository itemRepository) {
