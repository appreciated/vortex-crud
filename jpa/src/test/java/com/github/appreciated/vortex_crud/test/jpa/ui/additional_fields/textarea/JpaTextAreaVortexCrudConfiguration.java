...
public class JpaTextAreaVortexCrudConfiguration implements VortexCrudConfigurationProvider<JpaRepository<?, ?>, String, JpaRepository<?, ?>> {
    ...
    public JpaTextAreaVortexCrudConfiguration(
    ...
    private RouteRenderer<JpaRepository<?, ?>, String, JpaRepository<?, ?>> createTextAreaTestRoute() {
        var store = new JpaRepositoryDataStore<>(textAreaTestRepository, annotationRegistryService);
