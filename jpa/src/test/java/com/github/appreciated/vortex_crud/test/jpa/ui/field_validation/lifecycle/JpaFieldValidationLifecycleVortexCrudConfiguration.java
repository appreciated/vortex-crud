...
@Service
public class JpaFieldValidationLifecycleVortexCrudConfiguration implements VortexCrudConfigurationProvider<JpaRepository<?, ?>, String, JpaRepository<?, ?>> {

    private final JpaFieldValidationLifecycleRepository validationEntityRepository;
    private final JpaFieldService fieldService;
    private final JpaFieldAnnotationRegistryService annotationRegistryService;

    public JpaFieldValidationLifecycleVortexCrudConfiguration(JpaFieldValidationLifecycleRepository validationEntityRepository, JpaFieldService fieldService, JpaFieldAnnotationRegistryService annotationRegistryService) {
