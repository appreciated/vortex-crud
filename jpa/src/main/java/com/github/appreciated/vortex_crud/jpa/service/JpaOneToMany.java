...
public class JpaOneToMany<ModelClass> implements OneToMany<ModelClass, String, JpaRepository<?, ?>> {
    ...
    @Override
    public List<ModelClass> getData(Object foreignKeyValue, VortexCrudQueryDataStore<String, ?> dataStore, CollectionConfiguration<ModelClass, String, JpaRepository<?, ?>> collectionConfiguration) {
