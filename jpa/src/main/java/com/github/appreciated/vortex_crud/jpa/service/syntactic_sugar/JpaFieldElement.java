...
public class JpaFieldElement {
    public static InternalFormElement.InternalFormElementBuilder<JpaRepository<?, ?>, String, JpaRepository<?, ?>> of(String field, String label) {
