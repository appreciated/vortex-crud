...
/**
 * Example JPA configuration for Vortex CRUD.
 *
 * Routes can be accessed via: /test/{route-key} or /test/{route-key}/{entity-id}
 * Example: UI.getCurrent().navigate("test/projects-cards/123")
 */
@Service
public class ExampleJpaConfiguration implements VortexCrudConfigurationProvider<JpaRepository<?, ?>, String, JpaRepository<?, ?>> {
    ...
    public Application<JpaRepository<?, ?>, String, JpaRepository<?, ?>> get() {
        ...
        // Link to this route: UI.getCurrent().navigate("test/projects-cards")
        // Link to entity: UI.getCurrent().navigate("test/projects-cards/" + projectId)
        ...
        // Link to submenu child: UI.getCurrent().navigate("test/submenu/project-form")
