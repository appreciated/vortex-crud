        ...
        Map<TableImpl<?>, DataStoreConfig<TableRecord<?>, TableField<?, ?>, TableImpl<?>>> dataStores = Map.ofEntries(
                Map.entry(PROJECTS, JooqDataStoreConfig.of(PROJECTS)
                        .fields(Map.of(
                                ...
                                PROJECTS.NAME, JooqTextField.builder().required(true).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
                                PROJECTS.DESCRIPTION, JooqTextAreaField.builder().validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(500))).build(),
                ...
                Map.entry(TASKS, JooqDataStoreConfig.of(TASKS)
                        .fields(Map.of(
                                ...
                                TASKS.TITLE, JooqTextField.builder().required(true).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
                                TASKS.DESCRIPTION, JooqTextAreaField.builder().required(false).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
                ...
                Map.entry(TASK_COMMENTS, JooqDataStoreConfig.of(TASK_COMMENTS)
                        .fields(Map.of(
                                ...
                                TASK_COMMENTS.COMMENT_TEXT, JooqTextAreaField.builder().required(false).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(1000))).build(),
                ...
                Map.entry(IMAGES, JooqDataStoreConfig.of(IMAGES)
                        .fields(Map.of(
                                ...
                                IMAGES.TITLE, JooqTextField.builder().required(true).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
                ...
                Map.entry(VIDEOS, JooqDataStoreConfig.of(VIDEOS)
                        .fields(Map.of(
                                ...
                                VIDEOS.TITLE, JooqTextField.builder().required(true).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
                ...
                Map.entry(USERS,
                        JooqDataStoreConfig.of(USERS)
                                .fields(Map.of(
                                        ...
                                        USERS.PASSWORD_HASH, JooqPasswordField.builder().required(true).validators(List.of(com.github.appreciated.vortex_crud.core.validation.CommonValidators.stringMaxLength(255))).build(),
