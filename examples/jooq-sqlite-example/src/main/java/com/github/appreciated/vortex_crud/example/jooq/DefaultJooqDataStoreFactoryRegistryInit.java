...
public class DefaultJooqDataStoreFactoryRegistryInit {
    ...
    public DefaultJooqDataStoreFactoryRegistryInit(VortexCrudDataStoreFactoryRegistry<TableRecord<?>, TableField<?, ?>, Class<? extends TableRecord<?>>> registry, DSLContext dslContext) {
