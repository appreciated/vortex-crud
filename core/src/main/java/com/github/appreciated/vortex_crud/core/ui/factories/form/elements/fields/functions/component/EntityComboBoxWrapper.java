    ...
    public EntityComboBoxWrapper(VortexCrudDataStoreFieldNameResolver<FieldType> resolver,
        ...
        if (dataStore instanceof VortexCrudQueryDataStore) {
            ...
            comboBox.setDataProvider(
             ...
             // Fallback for simple data stores: fetch all and filter in memory (if possible) or just show all
             comboBox.setDataProvider(
                    (filterValue, i, i1) -> (java.util.stream.Stream<Object>) dataStore.getRecordsFromTable(i, i1).stream(), // Ignoring filter
