...
public class SingleFormRoute<ModelClass, FieldType, RepositoryType> implements FormRouteProvider<ModelClass, FieldType, RepositoryType> {
    ...
    public static class SingleFormRouteBuilder<ModelClass, FieldType, RepositoryType> {
        private DataStoreProvider<ModelClass, FieldType, RepositoryType> dataStore;
        public SingleFormRouteBuilder<ModelClass, FieldType, RepositoryType> dataStoreKey(RepositoryType key) {
            this.dataStore = new KeyDataStoreProvider<>(key);
            return this;
        }

        public SingleFormRouteBuilder<ModelClass, FieldType, RepositoryType> dataStore(VortexCrudDataStore<FieldType, ModelClass> store) {
            this.dataStore = new InstanceDataStoreProvider<>(store);
            return this;
        }

        public SingleFormRouteBuilder<ModelClass, FieldType, RepositoryType> dataStore(VortexCrudDataStore<FieldType, ModelClass> store, DataStoreConfig<ModelClass, FieldType, RepositoryType> config) {
