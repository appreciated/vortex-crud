...
public interface VortexCrudItemFactory<FieldId> {
    Component renderItem(ItemFactory<FieldId> itemFactory, Object entity, Integer maxWidth, VortexCrudFileProviderRegistry fileProvider, VortexCrudDataStoreFieldNameResolver<FieldId> resolver);
}
