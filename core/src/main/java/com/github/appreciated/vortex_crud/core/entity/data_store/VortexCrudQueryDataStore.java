...
public interface VortexCrudQueryDataStore<FieldType, ModelClass> extends VortexCrudDataStore<FieldType, ModelClass> {
     ...
     * @return The number of records matching the criteria
     */
    int countWhereFiltersEqual(List<RouteFilter<FieldType>> filters);
     ...
     * @return A list of records matching the criteria
     */
    List<ModelClass> getRecordsFromTableWhereFiltersEqual(List<RouteFilter<FieldType>> filters, int offset, int limit);
     ...
     * @return A list of records matching the criteria
     */
    List<ModelClass> getRecordsFromTableWhereColumnLikeAndFiltersEqual(FieldType searchField, Object searchValue, List<RouteFilter<FieldType>> filters, int offset, int limit);
     ...
     * @return The number of records matching the criteria
     */
    int countWhereColumnLikeAndFiltersEqual(FieldType searchField, String searchValue, List<RouteFilter<FieldType>> filters);
}
