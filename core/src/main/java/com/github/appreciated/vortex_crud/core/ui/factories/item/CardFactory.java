...
public class CardFactory<FieldType> implements VortexCrudItemFactory<FieldType> {
    ...
    @Override
    public Component renderItem(VortexCrudContext<?, FieldType, ?> context,
                                ItemFactory<FieldType> itemFactory,
                                Object entity,
                                Integer maxWidth) {
        return new DefaultCardItem<>(itemFactory, entity, maxWidth, context.getFileProviderRegistry(), context.getReflectionService());
    }
}
