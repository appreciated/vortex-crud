...
import com.github.appreciated.vortex_crud.core.ui.factories.route.treegrid.TreeGridRouteFactory;
...
@NoArgsConstructor
@Getter
public class TreeGridRoute<ModelClass, FieldType, RepositoryType> implements RouteRendererSingleChild<ModelClass, FieldType, RepositoryType>, AccessControlled {
    ...
    @lombok.NonNull
    private FieldType parentField;

    @lombok.NonNull
    private FieldType titleField;

    @Builder
    public TreeGridRoute(
            ...
            @lombok.NonNull FieldType parentField,
            @lombok.NonNull FieldType titleField
    ) {
        this.dataStoreConfig = dataStoreConfig;
        this.title = title;
        this.defaultRoute = defaultRoute;
        this.factory = factory != null ? factory : new TreeGridRouteFactory<>();
