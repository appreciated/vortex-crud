...
public class MultiFormRoute<ModelClass, FieldType, RepositoryType> implements RouteRenderer<ModelClass, FieldType, RepositoryType> {
    ...
    public static class MultiFormRouteBuilder<ModelClass, FieldType, RepositoryType> {
        private DataStoreProvider<ModelClass, FieldType, RepositoryType> dataStore;
        public MultiFormRouteBuilder<ModelClass, FieldType, RepositoryType> dataStoreKey(RepositoryType key) {
            this.dataStore = new KeyDataStoreProvider<>(key);
            return this;
        }

        public MultiFormRouteBuilder<ModelClass, FieldType, RepositoryType> dataStore(VortexCrudDataStore<FieldType, ModelClass> store) {
            this.dataStore = new InstanceDataStoreProvider<>(store);
            return this;
        }

        public MultiFormRouteBuilder<ModelClass, FieldType, RepositoryType> dataStore(VortexCrudDataStore<FieldType, ModelClass> store, DataStoreConfig<ModelClass, FieldType, RepositoryType> config) {
