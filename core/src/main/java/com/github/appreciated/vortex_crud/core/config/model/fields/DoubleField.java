 ...
 */
@Builder
public record DoubleField<ModelClass, FieldType, RepositoryType>(
    ...
    public static class DoubleFieldBuilder<ModelClass, FieldType, RepositoryType> {
        DoubleFieldBuilder() {
            factory = (Class<? extends VortexCrudFieldFactory<ModelClass, FieldType, RepositoryType>>) (Class<?>) DoubleNumberFieldFactory.class;
        }
    }
