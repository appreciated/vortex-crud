...
public class MultiFormRendererConfiguration<DataStoreId, FieldId> extends RouteRendererConfiguration<DataStoreId, FieldId> {
    ...
    public MultiFormRendererConfiguration(Class<? extends TurboCrudItemFactory<FieldId>> factory) {
        super(factory);
    }
    ...
    public static class Builder<DataStoreId, FieldId> {
        ...
        public static <DataStoreId, FieldId> Builder<DataStoreId, FieldId> of(Class<? extends TurboCrudItemFactory> factory) {
            return new Builder<>(new MultiFormRendererConfiguration<>((Class<? extends TurboCrudItemFactory<FieldId>>) factory));
        }
