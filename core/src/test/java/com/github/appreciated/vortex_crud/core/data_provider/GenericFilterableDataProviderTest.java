...
class GenericFilterableDataProviderTest {
    ...
    // Using QueryDataStore mock because tests exercise filtering logic
    @Mock
    ...
    void setUp() {
        ...
        dataProvider = new GenericFilterableDataProvider<>(dataStore, filterField, java.util.Collections.emptyList());
    }
