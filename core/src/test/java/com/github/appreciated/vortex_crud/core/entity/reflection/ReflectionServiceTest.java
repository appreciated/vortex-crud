...
class ReflectionServiceTest {
    ...
    void setUp() {
        ...
        when(mockResolver.getKeyForGenericFieldType(Mockito.anyString())).thenAnswer(invocation -> invocation.getArgument(0));
    }
    ...
    void testGetStringWithCamelCase() {
        ...
        when(mockResolver.getKeyForGenericFieldType("firstName")).thenReturn("firstName");
        when(mockResolver.getKeyForGenericFieldType("lastName")).thenReturn("lastName");
        when(mockResolver.getKeyForGenericFieldType("userAge")).thenReturn("userAge");
        when(mockResolver.getKeyForGenericFieldType("isActive")).thenReturn("active");
    ...
    void testSetValueInternalWithGetterSetterOnly() {
        ...
        when(mockResolver.getKeyForGenericFieldType("lastName")).thenReturn("lastName");
        when(mockResolver.getKeyForGenericFieldType("userAge")).thenReturn("userAge");
        when(mockResolver.getKeyForGenericFieldType("active")).thenReturn("active");
    ...
    void testGetStringWithSnakeCaseToCamelCase() {
        ...
        when(mockResolver.getKeyForGenericFieldType("start_date")).thenReturn("start_date");
        when(mockResolver.getKeyForGenericFieldType("end_date")).thenReturn("end_date");
        when(mockResolver.getKeyForGenericFieldType("user_count")).thenReturn("user_count");
        when(mockResolver.getKeyForGenericFieldType("is_completed")).thenReturn("is_completed");
    ...
    void testAddAll() {
        ...
        when(mockResolver.getKeyForGenericFieldType("stringList")).thenReturn("stringList");
        when(mockResolver.getKeyForGenericFieldType("integerSet")).thenReturn("integerSet");
        when(mockResolver.getKeyForGenericFieldType("doubleCollection")).thenReturn("doubleCollection");
