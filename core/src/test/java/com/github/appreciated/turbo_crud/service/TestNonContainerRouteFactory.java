...
public class TestNonContainerRouteFactory implements TurboCrudRouteFactory<String, String> {
    @Override
    public Component renderRoute(Integer currentPathIndex, TurboCrudPathToRouteResolver<String, String> routeResolver, @Nullable DetailRouteSetting detailRouteSetting) {
        return null;
    }
